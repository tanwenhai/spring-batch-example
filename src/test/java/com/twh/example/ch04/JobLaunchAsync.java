...
public class JobLaunchAsync {
    ...
    public static void executeJob(String jobPath, String jobName, JobParametersBuilder builder) {
        ...
        JobLauncher launcher = (JobLauncher) context.getBean("jobLauncherAsync");
    ...
    public static void main(String[] args) {
        executeJob("ch04/job/job.xml", "billJob",
                new JobParametersBuilder().addString("date", "20170202").addString("inputResource", "classpath:ch03/data/credit-card-bill-201303.csv"));
    }
}
